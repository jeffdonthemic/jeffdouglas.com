...
pubDate: "2009-06-24 14:23:29 +0300"
heroImage: '/images/slugs/google-app-engine-for-java-and-force-com-java-toolkit-demo.jpg'
tags:   ["google app engine", "salesforce", "java"]
slug: "2009/06/24/google-app-engine-for-java-and-force-com-java-toolkit-demo"
---
...
The application is a telesales use case and demonstrates some basic functionality of the Partner API as well as memcache for maintaining the connection to Salesforce.com. I also threw in some Spring framework for fun. You can browse/download the code from the link on the home page of the demo or from <a href="http://code.google.com/p/sfdc-wsc/source/browse/" target="_blank">this link</a>.

<strong>You can run the demo at:</strong>
