...
```
<strong>app/views/search.html.erb</strong>

The search view allows the user to search for an account and display the results.

```html
<span class="title">Welcome to the ACME Telesales Application (RoR on Heroku)</span>
