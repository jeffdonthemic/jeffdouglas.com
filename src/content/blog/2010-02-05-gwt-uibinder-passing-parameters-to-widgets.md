...
pubDate: "2010-02-05 15:02:38 +0300"
heroImage: '/images/slugs/gwt-uibinder-passing-parameters-to-widgets.jpg'
tags:   ["code sample", "gwt"]
slug: "2010/02/05/gwt-uibinder-passing-parameters-to-widgets"
---
...
<p style="clear: both">So here is the Entry Point class. When the module loads, it creates a new MyPanel object, passes the text "Random Text" to the constructor and then adds the panel to the RootPanel.

<strong>MyEntryPoint.java</strong>
...
<p style="clear: both">The MyPanel owner class defines a new constructor that accepts the passed string value (i.e. "Random Text") and sets the value of hidden field called <em>myField</em> in the UiBinder template to this text.

<strong>MyPanel.java</strong>
...
```
<p style="clear: both">When the UiBinder template runs, its owner class loads the value ("Random Text") into the Hidden field which then passes this same value into the SomeWidget widget.

<strong>MyPanel.ui.xml</strong>
...
```
<p style="clear: both">The SomeWidget owner class is fairly straight forward. There is a setter method for MyField which runs after the constructor, receives the text ("Random Text") and writes it to the <em>displayText</em> field in the UiBinder template.

<strong>SomeWidget.java</strong>
...
<strong>SomeWidget.ui.xml</strong>
