...
pubDate: "2009-09-25 18:57:31 +0300"
heroImage: '/images/slugs/cool-code-at-lunch-webinar-flex-salesforce.jpg'
tags:   ["appirio", "code sample", "salesforce", "visualforce", "flex"]
slug: "2009/09/25/cool-code-at-lunch-webinar-flex-salesforce"
---
...
You'll need to download the Force.com Toolkit for Adobe AIR and Flex toolkit <a href="http://developer.force.com/flextoolkit" target="_blank">here</a> to run this example.

<strong>Flex Application - main.mxml</strong>
...
```
<strong> Contact Value Object - Contact.as</strong>
...
```
<strong> Visualforce page - MyPage.page</strong>
