...
pubDate: "2010-01-07 14:04:10 +0300"
heroImage: '/images/slugs/using-list-custom-settings-in-salesforce-com.jpg'
tags:   ["code sample", "salesforce", "visualforce", "apex"]
slug: "2010/01/07/using-list-custom-settings-in-salesforce-com"
---
...
<a href="images/plxkqalxtxu2kb0d61vy.png"><img src="/images/plxkqalxtxu2kb0d61vy.png" alt="" ></a>
...
<a href="images/cdag6oekdz3vfupwwy4e.png"><img src="/images/cdag6oekdz3vfupwwy4e.png" alt="" ></a>
...
<a href="g/content/images/2014/Jun/qat87jadsdh96wkqbcn3.png"><img src="/images/qat87jadsdh96wkqbcn3.png" alt="" ></a>

Custom settings have their <a href="http://www.salesforce.com/us/developer/docs/apexcode/index.htm" title="Developer Docs">own instance methods</a> to allow easy access. It looks like the getInstance() and getValues() method returns the same object. I typically use the getInstance() method as it makes more sense to me. You access a record by using the value in the Name column (you cannot use the ID or other columns):
...
```
<a href="images/ntfmab1dprn7759zgnwt.png"><img src="/images/ntfmab1dprn7759zgnwt.png" alt="" ></a>

I put together a quick demo on how to use the ISO Countries custom setting in a Visualforce page for a picklist. <strong>You can <a href="https://jeffdouglas-developer-edition.na5.force.com/examples/CustomSettingsList">run this example</a> on my Developer Site.</strong>

<a href="https://jeffdouglas-developer-edition.na5.force.com/examples/CustomSettingsList"><img src="/images/janik0qdhfaw1mnykgk4.png" alt="" ></a>

<strong>Apex Controller - CustomSettingsListController</strong>
...
```
<strong>Visualforce Page - CustomSettingsList</strong>
