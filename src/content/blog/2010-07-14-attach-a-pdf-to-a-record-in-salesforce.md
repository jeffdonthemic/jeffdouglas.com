...
pubDate: "2010-07-14 12:57:33 +0300"
heroImage: '/images/slugs/attach-a-pdf-to-a-record-in-salesforce.jpg'
tags:   ["code sample", "salesforce", "visualforce", "apex"]
slug: "2010/07/14/attach-a-pdf-to-a-record-in-salesforce"
---
...
<strong>Note:</strong> there is a small issue when it comes to testing the Controller. Salesforce currently throws an error (Salesforce.com Error "Unable to retrieve object") when getContent or getContentAsPDF is called from a test method. There's an <a href="http://sites.force.com/ideaexchange/ideaView?c=09a30000000D9xt&id=08730000000HzknAAC" target="_blank">Idea to make this work</a> properly. I encourage everyone to vote for this.

<a href="/2010/07/14/attach-a-pdf-to-a-record-in-salesforce/attach-pdf/" rel="attachment wp-att-2867"><img src="http://res.cloudinary.com/blog-jeffdouglas-com/image/upload/v1400328003/attach-pdf_qywbr3.png" alt="" title="attach-pdf" width="500" class="alignnone size-full wp-image-2867" /></a>

<strong>PdfGenerator Visualforce Page</strong>
