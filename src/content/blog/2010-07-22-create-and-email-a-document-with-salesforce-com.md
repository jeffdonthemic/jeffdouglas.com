...
pubDate: "2010-07-22 09:39:28 +0300"
heroImage: '/images/slugs/create-and-email-a-document-with-salesforce-com.jpg'
tags:   ["code sample", "salesforce", "visualforce", "apex"]
slug: "2010/07/22/create-and-email-a-document-with-salesforce-com"
---
...
<p style="clear: both"><a href="/2010/07/22/create-and-email-a-document-with-salesforce-com/email-doc/" rel="attachment wp-att-2896"><img src="http://res.cloudinary.com/blog-jeffdouglas-com/image/upload/v1400328000/email-doc_wuheya.png" alt="" title="email-doc" width="500" class="alignnone size-full wp-image-2896" /></a>
<p style="clear: both"><strong>DocumentEmailer Visualforce Page</strong>
<p style="clear: both">
```html
...
<p style="clear: both"><strong>DocumentEmailController</strong>
<p style="clear: both">
```apex
...
<p style="clear: both"><strong>Test Class</strong>
<p style="clear: both">
```apex
@isTest
