...
<figure class="kg-card kg-embed-card"><iframe width="200" height="113" src="https://www.youtube.com/embed/FqeGxAuFqSM?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></figure><strong>Understanding Chatter</strong>
...
```
For more sample Chatter code, check out the <a href="http://wiki.developerforce.com/index.php/Chatter_Code_Recipes" target="_blank">Chatter Code Recipes</a>.

<b>Functional Design</b>
...
The application is a series of JSPs and Servlets and if you'd like the code for the entire project, <a href="http://www.twitter.com/jeffdonthemic" target="_blank">send me a message</a>. The interesting parts of the application are described below and hopefully you can extrapolate the rest.
...
```
<strong>SendChatterServlet</strong>
...
```
<strong>SendTweetServlet</strong>
