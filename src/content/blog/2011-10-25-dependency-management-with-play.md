...
require:
  ...
  - force-wsc -> force-wsc
```
When I run <em>play dependencies --verbose</em> in Terminal I get the following:
...
I worked with <a href="http://twitter.com/jesperfj">@jesperfj</a> this morning and he pointed me in the right direction. I needed to include the groupId and version as well. The correct syntax looks like:
