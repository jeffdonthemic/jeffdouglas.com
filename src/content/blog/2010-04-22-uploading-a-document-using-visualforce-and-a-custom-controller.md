...
pubDate: "2010-04-22 10:56:00 +0300"
heroImage: '/images/slugs/uploading-a-document-using-visualforce-and-a-custom-controller.jpg'
tags:   ["code sample", "salesforce", "visualforce", "apex"]
slug: "2010/04/22/uploading-a-document-using-visualforce-and-a-custom-controller"
---
<p style="clear: both">The <a href="http://www.salesforce.com/us/developer/docs/pages/Content/pages_compref_inputFile.htm" target="_blank">Salesforce docs</a> for the inputFile Visualforce component has an example of uploading a document using the Standard Controller. Here is a quick example of using a Custom Controller in case you want to make the upload process part of a larger transaction.
...
<blockquote style="clear: both">Maximum view state size limit (128K) exceeded. Actual viewstate size for this page was...
</blockquote><p style="clear: both"><strong>FileUploadExample</strong>
<p style="clear: both">
```html
...
```
<strong>FileUploadController</strong>
