...
pubDate: "2009-11-02 19:01:52 +0300"
heroImage: '/images/slugs/using-saleforce-dml-statements-or-dml-database-methods.jpg'
tags:   ["code sample", "salesforce", "apex"]
slug: "2009/11/02/using-saleforce-dml-statements-or-dml-database-methods"
---
...
```apex
UpsertResult Database.Upsert(sObject recordToUpsert, Schema.SObjectField External_ID_Field, Booleanopt_allOrNone)
...
This catches people once in awhile, but the following sObjects do not support <em>any type</em> of DML operations:
