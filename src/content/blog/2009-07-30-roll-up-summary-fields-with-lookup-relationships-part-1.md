...
pubDate: "2009-07-30 19:48:06 +0300"
heroImage: '/images/slugs/roll-up-summary-fields-with-lookup-relationships-part-1.jpg'
tags:   ["code sample", "salesforce", "apex"]
slug: "2009/07/30/roll-up-summary-fields-with-lookup-relationships-part-1"
---
...
So how do you perform this same type of functionality if you only have a lookup relationship? I ran across this same problem while doing some non-profit work for <a href="http://www.medisend.org" target="_blank">Medisend International</a> and the solution (with a caveat) is to write a trigger to perform the roll-up.
...
<strong>Trigger InventoryItemRollup.trigger</strong>
...
```
<strong>Unit Test - Test_InventoryItemRollup.cls</strong>
