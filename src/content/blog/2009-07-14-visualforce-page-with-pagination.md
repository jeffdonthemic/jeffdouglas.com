...
<strong>You can </strong><a href="http://jeffdouglas-developer-edition.na5.force.com/examples/category_paging" target="_blank"><strong>run this demo</strong></a><strong> on my developer site.</strong>

<a href="http://res.cloudinary.com/blog-jeffdouglas-com/image/upload/v1400399531/paging1_zs6vhq.png"><img class="alignnone size-full wp-image-1015" title="paging1" src="http://res.cloudinary.com/blog-jeffdouglas-com/image/upload/v1400399531/paging1_zs6vhq.png" alt="paging1" width="544" height="179" /></a>

<strong>PagingController.cls - Custom Controller</strong>
...
```
<strong>CategoryWrapper.cls - Wrapper class for the Categories</strong>
...
```
<strong>Category_Paging.page - Visualforce page</strong>
