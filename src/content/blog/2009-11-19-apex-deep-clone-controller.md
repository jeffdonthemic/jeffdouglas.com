...
pubDate: "2009-11-19 21:29:34 +0300"
heroImage: '/images/slugs/apex-deep-clone-controller.jpg'
tags:   ["code sample", "salesforce", "visualforce", "apex"]
slug: "2009/11/19/apex-deep-clone-controller"
---
I wrote the following code at the <a href="/2009/11/18/admin-to-hero-app-building-workshop/" target="_blank">Admin To Hero App Building Workshop</a> and it was very popular. I think we used the code on 3 or 4 projects that day so I thought I'd post it to help everyone out.
...
<strong>PurchaseOrderClone - Visualforce page</strong>
...
```
<strong>PurchaseOrderCloneWithItemsController - Apex controller</strong>
...
```
<strong>TestPurchaseOrderCloneWithController - Test class</strong>
