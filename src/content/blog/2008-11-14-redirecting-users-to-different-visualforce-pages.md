...
pubDate: "2008-11-14 19:53:57 +0300"
heroImage: '/images/slugs/redirecting-users-to-different-visualforce-pages.jpg'
tags:   ["code sample", "salesforce", "visualforce", "apex"]
slug: "2008/11/14/redirecting-users-to-different-visualforce-pages"
---
...
You'll need to override each button to call the specific Visualforce page. <a href="/2009/06/26/overriding-standard-links-with-visualforce-pages/" target="_blank">Here's more info</a> on how to do that.

<strong>Dispatcher_Contact_View</strong>
...
```
<strong>DispatcherContactViewController.cls</strong>
...
<strong>Dispatcher_Contact_Edit</strong>
...
```
<strong>DispatcherContactEditController.cls</strong>
...
```
<strong>Dispatcher_Contact_New</strong>
...
```
<strong>DispatcherContactNewController.cls</strong>
