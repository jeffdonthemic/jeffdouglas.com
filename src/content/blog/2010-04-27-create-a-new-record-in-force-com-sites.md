...
<p style="clear: both">Your code should look like the following:
<p style="clear: both"><strong>Contact_Create Visualforce Page</strong>
...
```
<strong>Contact_Create_Thankyou Visualforce Page</strong>
