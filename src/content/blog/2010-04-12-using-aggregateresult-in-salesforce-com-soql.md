...
<p style="clear: both">The AggregateResult returns the value as an object. So for some operations you will need to cast they value to assign them appropriately.
<p style="clear: both">
```apex
...
<p style="clear: both">One this to be aware of is that the count() function <strong>does not</strong> return an AggregateResult object. The resulting query result size field returns the number of rows:
<p style="clear: both">
```apex
...
<p style="clear: both">You can also do some cool things like embed the SOQL right in your expression:
<p style="clear: both">
```apex
