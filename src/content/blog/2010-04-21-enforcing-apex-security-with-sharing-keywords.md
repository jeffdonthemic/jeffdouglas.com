...
```
You can also use the <code>without sharing</code> keywords to ensure that Apex scripts <strong>do not enforce</strong> the sharing rules of the running user.
...
See the Apex Developer Guide on <a href="https://developer.salesforce.com/docs/atlas.en-us.apexcode.meta/apexcode/apex_security_sharing_rules.htm">enforcing sharing rules</a> for more info.
